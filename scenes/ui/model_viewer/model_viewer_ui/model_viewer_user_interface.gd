class_name ModelViewerUserInterface
extends CanvasLayer
...
@onready var _copy_messages_button: Button = %CopyMessagesButton
...
func _ready():
	_model_option_button.item_selected.connect(_on_model_option_button_item_selected)
	_render_mode_option_buttom.item_selected.connect(_on_render_mode_button_item_selected)
	_element_option_button.item_selected.connect(_on_element_option_button_item_selected)
	_object_item_list.multi_selected.connect(_on_object_item_list_multi_selected)
	_copy_messages_button.pressed.connect(_on_copy_messages_button_pressed)
	...
	var game_directory: String = config_service.get_game_install_directory()
