...
static func parse(context: ParseContext) -> ModelFileModel:
	var model: ModelFileModel = ModelFileModel.new()
...
class Frame:
	...
	static func deserialize(context: ParseContext) -> Frame:
...
class DegrFrameData extends FrameData:
	...
	static func deserialize(context: ParseContext) -> DegrFrameData:
...
class ElementFrameData extends FrameData:
	...
	static func deserialize(context: ParseContext) -> ElementFrameData:
		assert(context != null, 'Context must not be null')
...
class ObjectFrameData extends FrameData:
	...
	static func deserialize(context: ParseContext) -> ObjectFrameData:
		assert(context != null, 'Context must not be null')
...
class VertexArrayFrameData extends FrameData:
	...
	static func deserialize(context: ParseContext) -> VertexArrayFrameData:
		assert(context != null, 'Context must not be null')
	...
	class Vertex:
		...
		static func deserialize(context: ParseContext) -> Vertex:
			assert(context != null, 'Context must not be null')
...
class NormalArrayFrameData extends FrameData:
	...
	static func deserialize(context: ParseContext) -> NormalArrayFrameData:
		assert(context != null, 'Context must not be null')
	...
	class Normal:
		...
		static func deserialize(context: ParseContext) -> Normal:
			assert(context != null, 'Context must not be null')
...
class FaceArrayFrameData extends FrameData:
	...
	static func deserialize(context: ParseContext) -> FaceArrayFrameData:
		assert(context != null, 'Context must not be null')
	...
	class Face:
		...
		static func deserialize(context: ParseContext) -> Face:
			assert(context != null, 'Context must not be null.')
		...
		class VertexIndex:
			...
			static func deserialize(context: ParseContext) -> VertexIndex:
				assert(context != null, 'Context must not be null')
		...
		class UvCoordinate:
			...
			## Attempts to deserialize a vertex index from the provided context.
			static func deserialize(context: ParseContext) -> UvCoordinate:
				assert(context != null, 'Context must not be null')
...
class MaterialFrameData extends FrameData:
	...
	static func deserialize(context: ParseContext) -> MaterialFrameData:
		assert(context != null, 'Context must not be null')
...
class MaterialAttributeFrameData extends FrameData:
	...
	static func deserialize(context: ParseContext) -> MaterialAttributeFrameData:
		assert(context != null, 'Context must not be null')
...
class MapsFrameData extends FrameData:
	...
	static func deserialize(context: ParseContext) -> MapsFrameData:
		assert(context != null, 'Context must not be null')
...
class AnimationFrameData extends FrameData:
	...
	static func deserialize(context: ParseContext) -> AnimationFrameData:
		assert(context != null, 'Context must not be null')
